...
public class ExtractionController {
    ...
    /**
     * 데이터 추출 메소드
     * @param extractionRequestDto extractionRequestDto
    ...
    public Response<?> extractData(@ModelAttribute ExtractionRequestDto extractionRequestDto, Principal principal) {
